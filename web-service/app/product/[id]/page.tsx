...
const reviews = [
  {
    ...
    rating: 5,
    date: "2024.01.15",
    content: "음질이 정말 좋고 노이즈 캔슬링 기능이 뛰어납니다. 배터리도 오래가서 만족스러워요!",
    helpful: 24,
  },
  {
    id: 2,
    ...
    rating: 4,
    date: "2024.01.12",
    content: "디자인이 세련되고 착용감이 편안합니다. 가격 대비 성능이 우수해요.",
    helpful: 18,
  },
  {
    id: 3,
    ...
    <div className="py-8">
      <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
        ...
        <div className="space-y-6">
          <div>
            <h1 className="text-2xl lg:text-3xl font-bold mb-2">{productData.name}</h1>
            <div className="flex items-center gap-4 mb-4">
              <div className="flex items-center gap-1">
                ...
                <span className="text-sm text-muted-foreground">({productData.reviewCount}개 리뷰)</span>
              </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-3">
              <span className="text-3xl font-bold">{productData.price.toLocaleString()}원</span>
              ...
              {productData.colors.map((color) => (
                <button
                  ...
                  className={`w-10 h-10 rounded-full border-2 transition-colors ${
                    selectedColor.value === color.value ? "border-primary" : "border-muted"
                  }`}
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-muted-foreground">재고: {productData.stock}개</span>
            </div>
          </div>
      ...
      <div className="mt-16">
        <Tabs defaultValue="description" className="w-full">
          <TabsList className="grid w-full grid-cols-3">
            ...
            <TabsTrigger value="reviews">리뷰 ({productData.reviewCount})</TabsTrigger>
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="text-center mb-6">
                    <div className="text-4xl font-bold mb-2">{productData.rating}</div>
                    ...
                    <p className="text-sm text-muted-foreground">{productData.reviewCount}개 리뷰</p>
                  </div>
                  <div className="space-y-2">
