...
import { Filter, Grid3X3, List, Star, Heart, SlidersHorizontal, Search } from "lucide-react"
...
export default function CategoryPage({ params }: { params: { category: string } }) {
  ...
  const filteredProducts = useMemo(() => {
    ...
    return filtered
  }, [params.category, searchQuery, priceRange, selectedBrands, minRating, showInStockOnly, sortBy])
