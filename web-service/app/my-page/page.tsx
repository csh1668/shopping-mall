...
import { ArrowLeft, User, Package, MapPin, Heart, Settings, CreditCard, Bell, HelpCircle, LogOut } from "lucide-react"
  ...
  const menuItems = [
    {
      title: "주문 관리",
      items: [
        { name: "주문 내역", href: "/orders", icon: Package, description: "주문한 상품들을 확인하세요" },
        { name: "배송 추적", href: "/tracking", icon: Package, description: "배송 현황을 실시간으로 확인" },
      ],
    },
    {
      title: "계정 관리",
      items: [
        { name: "프로필 수정", href: "/profile", icon: User, description: "개인정보를 수정하세요" },
        { name: "배송지 관리", href: "/addresses", icon: MapPin, description: "배송지를 추가하고 관리하세요" },
        { name: "결제 수단", href: "/payment-methods", icon: CreditCard, description: "결제 수단을 관리하세요" },
      ],
    },
    {
      title: "쇼핑 관리",
      items: [
        { name: "찜한 상품", href: "/wishlist", icon: Heart, description: "관심 있는 상품들을 모아보세요" },
        { name: "쿠폰함", href: "/coupons", icon: Package, description: "사용 가능한 쿠폰을 확인하세요" },
      ],
    },
    {
      title: "설정 및 지원",
      items: [
        { name: "알림 설정", href: "/notifications", icon: Bell, description: "알림 설정을 관리하세요" },
        { name: "고객 지원", href: "/support", icon: HelpCircle, description: "도움이 필요하시면 문의하세요" },
        { name: "설정", href: "/settings", icon: Settings, description: "앱 설정을 변경하세요" },
      ],
    },
  ]
        ...
        <div className="container px-4 py-8">
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              ...
              <p className="text-muted-foreground">계정 정보와 주문을 관리하세요</p>
            </div>
          </div>
