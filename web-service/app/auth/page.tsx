          ...
          <CardContent className="pt-6">
            <div className="text-center space-y-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">환영합니다! 이제 ShopMall의 모든 서비스를 이용하실 수 있습니다.</p>
              </div>
    ...
    <div className="min-h-screen flex items-center justify-center bg-muted/30 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          <CardTitle className="text-2xl font-bold text-center">{mode === "login" ? "로그인" : "회원가입"}</CardTitle>
          <CardDescription className="text-center">
            {mode === "login" ? "ShopMall 계정으로 로그인하세요" : "ShopMall에 오신 것을 환영합니다"}
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-3">
            <SocialButton provider="google">Google로 {mode === "login" ? "로그인" : "회원가입"}</SocialButton>
            <SocialButton provider="kakao">카카오로 {mode === "login" ? "로그인" : "회원가입"}</SocialButton>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" className="w-full" disabled={isLoading}>
              {isLoading ? <LoadingSpinner size="sm" /> : mode === "login" ? "로그인" : "회원가입"}
            </Button>
          </form>
