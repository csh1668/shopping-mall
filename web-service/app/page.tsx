...
import { Star, Heart, ShoppingCart, TrendingUp, Zap, Gift } from "lucide-react"
...
const categories = [
  ...
  { name: "전자제품", href: "/category/electronics", icon: "📱", color: "bg-blue-100" },
  { name: "홈&리빙", href: "/category/home", icon: "🏠", color: "bg-green-100" },
  { name: "뷰티", href: "/category/beauty", icon: "💄", color: "bg-purple-100" },
  { name: "스포츠", href: "/category/sports", icon: "⚽", color: "bg-orange-100" },
    ...
    <div className="space-y-12 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {categories.map((category, index) => (
            <Link key={category.name} href={category.href}>
              <AnimatedCard className="p-6 text-center cursor-pointer group" delay={index * 100}>
                <div
      ...
      <section className="grid md:grid-cols-3 gap-6">
        <AnimatedCard className="p-6 text-center" delay={0}>
          ...
          <p className="text-sm text-muted-foreground">최신 트렌드를 반영한 다양한 상품들을 만나보세요</p>
        </AnimatedCard>
        ...
        <AnimatedCard className="p-6 text-center" delay={100}>
          ...
          <p className="text-sm text-muted-foreground">전국 어디든 빠르고 안전한 배송 서비스를 제공합니다</p>
        </AnimatedCard>
        ...
        <AnimatedCard className="p-6 text-center" delay={200}>
          ...
          <p className="text-sm text-muted-foreground">회원만을 위한 특별한 할인과 이벤트를 놓치지 마세요</p>
        </AnimatedCard>
      </section>
      ...
      <section className="text-center space-y-6 py-12 bg-muted/30 rounded-lg">
        ...
        <p className="text-muted-foreground max-w-md mx-auto">ShopMall에서 최고의 쇼핑 경험을 만나보세요</p>
